...
CREATE TABLE `post_images`  (
  ...
  INDEX `fk_post_images_file`(`file_id`) USING BTREE,
...
CREATE TABLE `product_images`  (
  ...
  INDEX `fk_product_images_file`(`file_id`) USING BTREE,
...
CREATE TABLE `users`  (
  ...
  INDEX `fk_users_avatar_file`(`avatar_file_id`) USING BTREE,
