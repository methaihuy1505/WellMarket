  ...
  return (
    <header className="flex items-center justify-between px-6 py-2 bg-white shadow-sm">
      ...
      <div className="flex-grow px-9 ">
        <div
          className="flex items-center bg-gray-100 rounded-full pl-3  w-full
                                 "
        >
          <input
            type="text"
      ...
      <div className="flex items-center space-x-3 shrink-0">
        <button
          className="text-3xl text-gray-600 border-gray-300  
                                hover:shadow-xl hover:shadow-gray-500 rounded-full w-10 h-9"
        >
          <img src="src\assets\heart.png" alt="" className="rounded-full" />
        </button>
        <button
          className="text-xl text-gray-600 border-gray-300  
                                hover:shadow-xl hover:shadow-gray-500 rounded-full w-10 h-9 flex items-center justify-center"
        >
          <img src="src\assets\message.png" alt="" className="rounded-full" />
        </button>
        <button
          className="text-md text-gray-600 border-gray-300 
                                hover:shadow-xl hover:shadow-gray-500 rounded-full w-10 h-9"
        >
          <img
            src="src\assets\notificaion.png"
